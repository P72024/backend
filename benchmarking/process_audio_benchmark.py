...
async def process_audio_benchmark(chunks_pkl, txt_filename, size, max_ctx_length):
    asr = ASR(model_size=size, device="auto", compute_type="float32", max_context_length=max_ctx_length)
    transcribed_text = ""
    actual_text = ""
