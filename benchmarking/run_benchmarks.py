...
async def run_benchmarks():
    await process_audio_benchmark(f"{get_absolute_path('testfiles/parl1.pkl')}", f"{get_absolute_path('testfiles/parl1_meta.pkl')}", f"{get_absolute_path('testfiles/parl1.txt')}", size)
